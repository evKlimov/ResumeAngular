...
export class InfoService {
  ...
  GetProjects() {
    return [
      { project: 'mediajobs.ru', link: 'https://mediajobs.ru/', description: 'Russias largest specialized platform for posting vacancies and searching for employees in the media.', headerImage: 'mj', technologies: ['.Net', 'Jquery', 'MSSQL', 'ElasticSearch', 'HTML5', 'CSS3', 'Compas Sass', 'AngularJS', 'Emtity Framework', 'Google API'] },
      { project: 'rusmice.com', link: 'https://www.rusmice.com/', description: 'Is the leading provider of DMC-services in Russia and CIS countries, travel agency platform', headerImage: 'rm', technologies: ['.Net', 'Jquery', 'MSSQL', 'HTML5', 'CSS3', 'AngularJS', 'Emtity Framework', 'Google API'] },
      { project: 'Real-estate project (USA based client)', link: 'https://buildingbits.com/', description: 'A real-estate investment platform with the option of buying shares of the buildings. This is a big platform that was several times noticed by financial publishers and US based federal financial conferences.', headerImage: 'bb', technologies: ['.Net', 'Jquery', 'MSSQL', 'HTML5', 'CSS3', 'Emtity Framework'] },
